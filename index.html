...
<body>
  ...
  <script>
    const API_KEY = "e256fa8b-7df7-4264-8bbd-2d142e2d0a45";
    ...
    async function handleBypass() {
      ...
      try {
        ...
        if (useV2 && data.ThreadID) {
          resultBox.textContent = "Task started — polling for completion...";
    ...
    async function pollThread(threadId) {
      ...
      resultBox.textContent = "Timed out after 60 seconds — no result received.";
    }
